...
import DateFormatRight from "@/components/Conversion/DateFormatRIght";
...
const SummaryCardRight = ({ interns, companyId }: Props) => {
                    ...
                    {editingIndex === index ? (
                        ...
                        <div>
                            <div style={{ display: "flex" }}>
                                <div style={{ flex: 1 }}>
                                    <div style={{ display: "flex" }}>
                                        <div style={{ flex: 1 }}><DateFormatRight value={String(intern.date)} /></div>
                                        <div style={{ flex: 1 }}><TimeFormat value={String(intern.time).padStart(4, "0")} /></div>
                                    </div>
                                    <div>
                                        <span style={{ fontSize: "1rem" }}>{intern.title}</span> <span style={{ fontSize: "1rem" }}>{intern.place}</span>
                                    </div>
                                </div>
...
export default SummaryCardRight;